...
interface props {}
const DropItemForm: React.FC<props> = ({}) => {
  return (
      ...
      <View>
        ...
        <View>
          <View style={styles.listItems}>
            <EvilIcons  color={colors.brand[50]} size={20} name="location" />
            <SpacingX width={4} />
            <Text style={styles.title}>3, Olaniyi Street, Idi Oro, Lagos</Text>
          </View>
          <SpacingY height={4} />
          <View style={styles.listItems}>
            <AntDesign color={colors.brand[50]} size={16} name="phone" />
            <SpacingX width={7} />
            <Text style={styles.title}>0908 790 8769, 0112 789 8789</Text>
          </View>
          <SpacingY height={4} />
          <View style={styles.listItems}>
            <AntDesign color={colors.brand[50]} size={16} name="clockcircleo" />
            <SpacingX width={7} />
            <Text style={styles.title}>9:00am - 4:00pm</Text>
          </View>
          <SpacingY height={4} />
          <View style={styles.listItems}>
            <Entypo color={colors.brand[50]} size={16} name="suitcase" />
            <SpacingX width={7} />
